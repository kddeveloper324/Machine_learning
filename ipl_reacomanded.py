...
if st.button("🔮 Predict Future Match Outcome", type="primary"):
    ...
    try:
        # --- FIX: Create a DataFrame instead of numpy array to solve warning ---
        ...
        # --- LOGIC UPDATE: Force prediction to be one of the two selected teams ---
...
# Removed the sidebar disclaimer as requested